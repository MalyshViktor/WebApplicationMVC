...
namespace WebApplicationMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ViewResult> CosmosAsync()
        {
            ...
            /*foreach (UserModel usersFeedback in users)
            {
                usersFeedback.Feedbacks!.Add(feedbacks.Find(f => f.AuthorId == usersFeedback.Id));
            }
            */
        ...
        */
        ...
        public IActionResult Register()
        {
            ...
            ViewData["UserData"] = this.HttpContext.Session.GetString("UserData");
            return View();
        }

        public IActionResult Privacy()
        {
            ViewData["fromSession"] = this.HttpContext.Session.GetString("sKey");
            return View();
        }
